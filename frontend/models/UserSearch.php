...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'ancestor_id', 'parent_id', 'left_id', 'right_id', 'is_admin', 'gender', 'birthYear', 'deathYear', 'status'], 'integer'],
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'fullname', 'spouse', 'description', 'worshipPlace', 'image', 'created_at', 'updated_at', 'images', 'videos'], 'safe'],
        ];
    }
